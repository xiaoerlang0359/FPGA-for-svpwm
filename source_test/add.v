...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" DIRECTION="VARIABLE" OPTIMIZE="SPEED" PIPELINE=10 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 add_sub clock dataa datab result
...
endmodule //add_altfp_add_sub_uek
//VALID FILE
...
module add (
	...
	add_altfp_add_sub_uek	add_altfp_add_sub_uek_component (
				.add_sub (add_sub),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),

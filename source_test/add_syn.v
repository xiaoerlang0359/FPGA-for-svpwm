...
//altfp_add_sub DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" DIRECTION="VARIABLE" OPTIMIZE="SPEED" PIPELINE=10 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 add_sub clock dataa datab result
...
//lpm_add_sub DEVICE_FAMILY="Cyclone IV E" LPM_DIRECTION="SUB" LPM_PIPELINE=1 LPM_REPRESENTATION="SIGNED" LPM_WIDTH=9 USE_WYS="ON" aclr clken clock dataa datab result
...
`endif
	...
	defparam
		add_sub_cella_0.lut_mask = 16'h69B2,
	...
	defparam
		add_sub_cella_1.lut_mask = 16'h69B2,
	...
	defparam
		add_sub_cella_2.lut_mask = 16'h69B2,
	...
	defparam
		add_sub_cella_3.lut_mask = 16'h69B2,
	...
	defparam
		add_sub_cella_4.lut_mask = 16'h69B2,
	...
	defparam
		add_sub_cella_5.lut_mask = 16'h69B2,
	...
	defparam
		add_sub_cella_6.lut_mask = 16'h69B2,
	...
	defparam
		add_sub_cella_7.lut_mask = 16'h69B2,
	...
	defparam
		add_sub_cella_8.lut_mask = 16'h69B2,
...
//synthesis_resources = lut 168 reg 621 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
`endif
	...
	add_add_sub12   man_2comp_res_lower
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(borrow_w),
	...
	add_add_sub123   man_2comp_res_upper0
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b0),
	...
	add_add_sub123   man_2comp_res_upper1
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b1),
	...
	add_add_sub12   man_add_sub_lower
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(borrow_w),
	...
	add_add_sub123   man_add_sub_upper0
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b0),
	...
	add_add_sub123   man_add_sub_upper1
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b1),
